...
# Sentiment Analysis on Amazon Fine Food Reviews Data[^1]

[^1]: Click the GitHub icon on the top right corner of the page to view all the project files including the dataset.
...
```{r sent_analysis1, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r sent_analysis2, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r sent_analysis4, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r sent_analysis5, message=FALSE, warning=FALSE, out.width="100%"}
